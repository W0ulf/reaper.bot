...
bot.on('ready', () =>{
    ...
    switch(args[0]){
        ...
        case 'ranks':
            ...
            .addField("Glorious (50)", "This role is obtained by reaching lvl 50 with MEE6 this comes with access to the colored roles.")
            .addField("Legendary (60)", "This role is obtained by reaching lvl 60 with MEE6 this comes with access to the colored roles.")
            .addField("Nolife (70)", "This role is obtained by reaching lvl 70 with MEE6 this comes with access to the colored roles.")
            .addField("Goat (80)", "This role is obtained by reaching lvl 80 with MEE6 this comes with access to the colored roles.")
            .addField("Satan (90)", "This role is obtained by reaching lvl 90 with MEE6 this comes with access to the colored roles.")
            .addField("God (100)", "This role is obtained by reaching lvl 100 with MEE6 this comes with access to the colored roles.")
