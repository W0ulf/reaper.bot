...
bot.on('ready', () =>{
    ...
    switch(args[0]){
        ...
        case 'ranks':
            ...
            .addField("Rookie (20)", "This role is obtained by reaching lvl 20 with MEE6 this comes with image perms and nickname perms.")
            .addField("Epic (30)", "This role is obtained by reaching lvl 30 with MEE6 this comes with image perms and nickname perms.")
            .addField("Mythical (40)", "This role is obtained by reaching lvl 40 with MEE6 this comes with access to the colored roles.")
            .addField("Glorious (50)", "This role is obtained by reaching lvl 50 with MEE6 has access to the colored roles.")
            .addField("Legendary (60)", "This role is obtained by reaching lvl 60 with MEE6 has access to the colored roles.")
            .addField("Nolife (70)", "This role is obtained by reaching lvl 70 with MEE6 has access to the colored roles.")
            .addField("Goat (80)", "This role is obtained by reaching lvl 80 with MEE6 has access to the colored roles.")
            .addField("Satan (90)", "This role is obtained by reaching lvl 90 with MEE6 has access to the colored roles.")
            .addField("God (100)", "This role is obtained by reaching lvl 100 with MEE6 has access to the colored roles.")
            ...
            .addField("Midnight", "This role is obtained by buying all the midnight merch.")
            ...
            .addField("The Hand", "These are the admins there will only ever be 5 at a time hehe its like 5 fingers on a hand woah.")
