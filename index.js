...
bot.on('ready', () =>{
    ...
    switch(args[0]){
        ...
        case 'ranks':
            ...
            .addField("Epic (30)", "This role is obtained by reaching lvl 30 with MEE6.")
            .addField("Mythical (40)", "This role is obtained by reaching lvl 40 with MEE6 this comes with access to the colored roles.")
            .addField("Glorious (50)", "This role is obtained by reaching lvl 50 with MEE6.")
            ...
            .addField("Staff", "This role is for to the people with the Trial Mod, Silencer, The Hand, Speaker and Listener role.")
